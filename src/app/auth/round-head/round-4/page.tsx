...
export default function Round4() {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      try {
        ...
        // Get round data
        const roundRes = await fetch('/api/rounds/round-4')
  ...
  const saveScores = async () => {
    ...
    try {
      ...
      await fetch('/api/rounds/round-4', {
        method: 'POST',
        headers: {
  ...
  const awardHouse = async (house:string, roundId='round-4') => {
